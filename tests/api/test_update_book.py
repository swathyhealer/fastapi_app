...
class TestUpdateBook:
    ...
    def test_update_book_fail_no_permission(
        self, admin_login, user_login, get_client, get_book_name
    ):
        ...
        fake_owner_data = {"email": random_email, "password": random_password}

        fake_user_response = get_client.post(
            "/admin/user/create",
            json=fake_owner_data,
        ...
        response = get_client.put(
            ...
            headers={"Authorization": f"Bearer {fake_owner_access_token}"},
        )
